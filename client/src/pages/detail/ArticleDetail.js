...
class ArticleDetail extends React.Component{
  ...
  async commentChange(articleId){
    ...
    const tag = await updateCommentNum(articleId);
    console.log(tag);
    this.setState({
      comments:comments,
      commentsTotal:commentsTotal.length
  ...
  async replyChange(articleId,commentId){
    const tag1 = await updateCommentNum(articleId);
    console.log(tag1);
    const tag2 = await updateReplyNum(commentId);
    console.log(tag2);
